...
- Project Templates: `/orchestrator/memory/project_templates.json`
- Learning Metrics: `/orchestrator/memory/learning_metrics.json`
...
1. **Read memory files for context:**
   - Read /orchestrator/memory/success_patterns.json
