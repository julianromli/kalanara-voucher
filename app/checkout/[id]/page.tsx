                ...
                <div className="space-y-4">
                  ...
                  <div>
                    ...
                    <textarea
                      ...
                      rows={3}
                      className="w-full px-3 py-2 border border-border rounded-lg focus:outline-none focus:ring-2 focus:ring-ring resize-none placeholder:text-sand-400 dark:placeholder:text-sand-500"
                    />
                  </div>
                </div>
              </div>
