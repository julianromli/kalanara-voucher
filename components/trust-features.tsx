...
const TrustFeatures = ({ copy }: TrustFeaturesProps) => {
  ...
  return (
    <section
      id="trust"
      ref={sectionRef}
      className="relative overflow-hidden bg-primary py-24 text-primary-foreground scroll-mt-36"
    >
      ...
      <SiteContainer className="relative z-10">
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
          {copy.features.map((feature, index) => {
            const Icon = TRUST_ICONS[index] ?? Zap;
